...
$foto = BASE_URL . '/assets/img/' . $foto_file;
...
<div id="sidebar-wrapper" class="<?= $mode_class ?> border-end">
  ...
  <div class="list-group list-group-flush mt-3">
    <!-- Toko -->
    <a href="<?= BASE_URL ?>/toko/toko"
      class="list-group-item list-group-item-action <?= $currentFile === 'dashboard' ? 'active' : '' ?> "
      >
    ...
    <!-- Meteran -->
    <a href="<?= BASE_URL ?>/meteran/meteran"
    ...
    <a href="<?= BASE_URL ?>/laporan/laporan"
      class="list-group-item list-group-item-action <?= $currentFile === 'laporan' ? 'active' : '' ?> "
      >
