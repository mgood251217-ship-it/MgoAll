...
$resultMaklunan = $stmtMaklunan->get_result();
...
$resultNgemaklun = $stmtNgemaklun->get_result();
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <div class="table-responsive">
          <table class="table table-bordered table-striped " id="tableMaklun">
          <thead class="table-primary">
            ...
            <tbody>
              <?php
                $noMaklunan = 0;
                while ($m = $resultMaklunan->fetch_assoc()) {
                  $noMaklunan++;
              ?>
             <tr>
              <td><?= $noMaklunan ?></td>
              ...
              <td>
                <?php 
                  echo getFinishingNames($m['finishing'], $koneksi);
                ?>
              </td>
              <td><?= $m['quantity'] ?></td>
              <td>
                <?php
                  ...
                  $total_satuan = getSatuanHarga($m['product_id'], $size, $m['finishing'], $koneksi);
                  echo $total_satuan;
                ?>
              </td>
              <td>
                <?php
                  echo $total_satuan * $m['quantity'];
                ?>
              </td>
              <td>
                <?php 
                $ambilStore = $m['store_id'];
                echo getBranchName($ambilStore, $koneksi);
                ?>
              </td>
              <td>
                <?= date('Y-m-d', strtotime($m['date'])) ?>
              </td>
             </tr>
              <?php
                }
      ...
      <div class="col-md-6">
        ...
        <div class="table-responsive">
          <table class="table table-bordered table-striped" id="tableNgemaklun">
            <thead class="table-primary">
              <tr>
                <th>No</th>
                <th>Judul</th>
            ...
            <tbody>
              <?php
                $noNgemaklun = 0;
                while ($m = $resultNgemaklun->fetch_assoc()) {
                  $noNgemaklun++;
              ?>
            <tr>
              <td><?= $noNgemaklun ?></td>
...
document.getElementById('btnExportExcel').addEventListener('click', async () => {
  ...
  const headersMasuk  = [...tableMasuk.querySelectorAll("thead th")].map(th => th.innerText);
  const headersKeluar = [...tableKeluar.querySelectorAll("thead th")].map(th => th.innerText);
